...
export type { RelationTupleStringGenerator } from './lib/with-replacements/relation-tuple-with-replacements-parser.js';
export { parseRelationTupleWithReplacements } from './lib/with-replacements/relation-tuple-with-replacements-parser.js';
export type { ReplacementValues } from './lib/with-replacements/replacement-values.js';
