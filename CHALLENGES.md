...
This repository is the companion of the [ticketing repository](https://github.com/getlarge/ticketing) and the [NestJS workshop slides](https://slides.com/edouard_maleix/nestjs-workshop).
It contains the exercises and solutions for the workshop.
